...
from .utils.amg import batch_iterator

class SamPredictor_training:
    def __init__(
        self,
        sam_model: Sam,
    ) -> None:
        ...
        self.transform = ResizeLongestSide(224)
        self.reset_image()
    ...
    def forward(self,
        ...
        all_for_img = (point_coords, point_labels, boxes, mask_input)
        ...
        for batches in batch_iterator(200, *all_for_img):
            points_, labels_, boxes_, mask_input_ = [batches.pop(0) if x else None for x in cond]
            masks_, iou_predictions_, low_res_masks_ = self.predict_torch(
